...
## Date : 10/08/2018 	
## Version : 3.0
## Description : Display all the possible information and create logs of the PIQ Server
...
echo -e "Date,Time,PIQ Version,CPU,RAM Size, Boot Disk Size, Boot Disk Used,Disk Size,Disk Used,DB Disk Size,DB Disk Used,BUP Size,BUP Time,MySQL DB Size
" > piqstatus.csv